...
Path_SiteXCovCrop = '../output/31b_SiteXcovCrop/';

system(['rm -rf '  ,Path_SiteXCovCrop]);
system(['mkdir -p ',Path_SiteXCovCrop]);
...
% 数据清理，去除无效值
Invalid =~(SiteData_PFT == 12| SiteData_PFT == 14); 
...
Xcov = [SiteData_Ta,SiteCEC,SiteData_VPD,SiteData_Rg,SitePH,SitePre,SiteSOC,SiteData_Aspect,SiteData_DEM,SiteData_Soilmo,...
    SiteData_Ozone,SiteData_CO2,SiteAI,SiteAlpha,SiteIrri,SiteSWC];


save([Path_SiteXCovCrop, 'SiteXcov.mat'],'-regexp','^Xcov*');  
