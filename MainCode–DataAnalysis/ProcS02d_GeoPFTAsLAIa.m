...
Path_GeoPFTAsLAIa = '../output/S02d_GeoPFTAsLAIa/';


system(['rm -rf '  ,Path_GeoPFTAsLAIa]);
system(['mkdir -p ',Path_GeoPFTAsLAIa]);
...
IndexENF = find(LandCover == 1);  %No data
...
save([Path_GeoPFTAsLAIa,'GeoPFTAsLAI.mat'],'-regexp','^LAI*','^BoxBio*','^P*');
