...
system(['rm -rf '  ,Path_MulDiffAGB]);
system(['mkdir -p ',Path_MulDiffAGB]);


% 读取风险区掩码
GeoAsType = readgeoraster([Path_GeoAsType,'AsType.TargetPixel.ControlPixel.CMG1KM.tif']);

AGB = readgeoraster([Path_MulYAGB,'EcoServ_AVGAGB_CMG1KM_B2001E2019.tif']);
...
FileName =[Path_MulDiffAGB,'WinAGBLoss.CMG083DEG.tif'];
geotiffwrite(FileName,LossAGB,R,'TiffTags',struct('Compression',Tiff.Compression.LZW));

FileName =[Path_MulDiffAGB,'WinAGBTotal.CMG083DEG.tif'];
