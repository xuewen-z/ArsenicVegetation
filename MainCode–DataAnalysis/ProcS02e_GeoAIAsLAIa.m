...
Path_GeoAIAsLAIa = '../output/S02e_GeoAIAsLAIa/';



system(['rm -rf '  ,Path_GeoAIAsLAIa]);
system(['mkdir -p ',Path_GeoAIAsLAIa]);
...
save([Path_GeoAIAsLAIa,'AIAsLAIa.mat'],'-regexp','^LAI*','^BoxBio*','^P*');
