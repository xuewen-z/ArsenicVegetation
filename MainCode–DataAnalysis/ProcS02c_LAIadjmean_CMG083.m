...
Path_LAImean = '../output/S02c_LAIadjmean_CMG083/';
...
LAIadj = double(readgeoraster(File_LAI));
        ...
        for j = 1 : WinSize : size(GeoAsType,2)   
            NumCol = NumCol + 1; 
                       ...
                       StartCol = j:min(WinSize + j -1, size(GeoAsType,2));
                        ...
                        WinLAI = LAIadj(StartRow, StartCol);
...
disp('Done. LAI mean values for LRAs, MRAs, and HRAs saved at 0.83° resolution.');
