...
- `MainCode-DataAnalysis/` : main MATLAB-based analytical scripts for vegetation anomaly analysis, site-based statistical analyses, and ecosystem service analyses
...
4. Update file paths in the scripts according to your local directory structure before running.
